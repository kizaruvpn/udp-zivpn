...
# wget -O backup.zip https://filename.web.id/bot-1769181309917-zivpn_backup_103.200.219.189_20260123-211838.zip && unzip -P "AriZiVPN-Gacorr123!" -o "backup.zip" -d "/etc/zivpn"
...
handle_backup() {
  ...
  # Ambil IP VPS (fallback kalau file ga ada / kosong)
  ...
  # ===== Caption sesuai yang kamu mau (TANPA dobel pesan) =====
...
3) Paste link saat proses restore"
  ...
  # Kirim dokumen ke user bot (atau fallback owner bot)
  ...
  # Ambil message_id, lalu edit caption supaya ada "Dikirim via: ..."
